            ...
            Form(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: 15.h),
                  TextInputComponent(
                    focusNode: controller.ganderFocusNode,
                    controller: controller.ganderController,
                    label: StringsAssetsConstants.gander,
                    onTap: (context) => showGanderSelectorWindow(),
                    isLabelOutside: true,
                    readOnly: true,
                    borderColor: MainColors.textColor(context),
                    hint: '${StringsAssetsConstants.select} ${StringsAssetsConstants.gander}...',
                    validate: (value) => ValidatorUtil.nullableValidation(controller.selectedGander,
                        customMessage: '${StringsAssetsConstants.check} ${StringsAssetsConstants.gander}'),
                  ),
                ],
              ),
            ),
